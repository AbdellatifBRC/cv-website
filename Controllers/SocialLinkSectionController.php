                    ...
                    <div class='row link' id='link_" . strval($socialLinksNumber->value + 1) . "'>
                        <form id='save_link_" . strval($socialLinksNumber->value + 1) . "_section_form'>
                            <div class'col-sm-4'>
                                ...
                                <input type='text' class='form-control cv-input-1' placeholder='' name='website_name' id='website-name-" . strval($socialLinksNumber->value + 1) . "'>
                            </div>
                            <div class'col-sm-4'>
                                <label for='link-" . strval($socialLinksNumber->value + 1) . "' class='form-label'>lien</label>
                                <input type='text' class='form-control cv-input-1' placeholder='' name='website_link' id='link-" . strval($socialLinksNumber->value + 1) . "'>
                            </div>
                            <div class'col-sm-4'>
                    ...
                    <div class='row social_link' id='social_link_" . $socialLink["id"] . "'>
                        <form id='save_social_link_" . $socialLink["id"] . "_section_form'>
                            <div class'col-sm-4'>
                                ...
                                <input type='text' class='form-control cv-input-1' placeholder='' name='website_name' id='website-name-" . $socialLink["id"] . "' value='" . str_replace("'", "&apos;", str_replace('"', "&quot;", $socialLink["website_name"])) . "'>
                            </div>
                            <div class'col-sm-4'>
                                <label for='link-" . $socialLink["id"] . "' class='form-label'>lien</label>
                                <input type='text' class='form-control cv-input-1' placeholder='' name='website_link' id='link-" . $socialLink["id"] . "' value='" . str_replace("'", "&apos;", str_replace('"', "&quot;", $socialLink["link"])) . "'>
                            </div>
                            <div class'col-sm-4'>
                    ...
                    <div class='row social_link' id='social_link_1'>
                        <form id='save_social_link_1_section_form'>
                            ...
                            <div class'col-sm-4'>
                                ...
                                <input type='text' class='form-control cv-input-1' placeholder='' name='website_link' id='link-1'>
                            </div>
                            <div class'col-sm-4'>
